using BookStoreTask.Application.Features.Orders.GetOrdersForMonth;
using MediatR;
...
namespace BookStoreTask.API.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<PagedOrdersForMonthVm>>
            GetPagedOrdersForMonth(
            DateTime date, int page, int size)
        {
            var getOrdersForMonthQuery = 
                new GetOrdersForMonthQuery() {
                    Date = date, Page = page, Size = size };
