using BookStoreTask.Application.Contracts;
   ...
   public class BookDbContext : DbContext
    {
        ...
        public DbSet<BookRent> Events { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookRent>().HasData(new BookRent
            {
                BookId = Guid.Parse("{EE272F8B-6096-4CB6-8625-BB4BB2D89E8B}"),
            ...
            modelBuilder.Entity<BookRent>().HasData(new BookRent
            {
                BookId = Guid.Parse("{3448D5A4-0F72-4DD7-BF15-C14A46B26C00}"),
            ...
            modelBuilder.Entity<BookRent>().HasData(new BookRent
            {
                BookId = Guid.Parse("{B419A7CA-3321-4F38-BE8E-4D7B6A529319}"),
            ...
            modelBuilder.Entity<BookRent>().HasData(new BookRent
            {
                BookId = Guid.Parse("{62787623-4C52-43FE-B0C9-B7044FB5929B}"),
                Name = "Spanish guitar hits with Manuel",
                Price = 25,
                Author = "Manuel Santinonisi",
                Date = DateTime.Now.AddMonths(4),
            ...
            modelBuilder.Entity<BookRent>().HasData(new BookRent
            {
                BookId = Guid.Parse("{1BABD057-E980-4CB3-9CD2-7FDD9E525668}"),
                Name = "Techorama 2021",
                Price = 400,
                Author = "Many",
            ...
            modelBuilder.Entity<BookRent>().HasData(new BookRent
            {
                BookId = Guid.Parse("{ADC42C09-08C1-4D2C-9F96-2D15BB1AF299}"),
